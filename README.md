...
O **Site Codechella Challenger-Alura** é um site de com temática do Challenger da Alura desenvolvido com o propósito de aprendizado, seguindo o roadmap [RoadMap ETAPA 1 - HTML E CSS] PROJETO 3.

## Tabela de Conteúdos 

- [Site CodeChella](#Site-Codechella-Challenger-Alura)
- [Descrição](#descrição)
...
```bash
git clone https://github.com/Damniel-Guilherme/Site_Codechella_Challenger-Alura.git
```

2. **Acesse o diretório do projeto:** 📁
```bash
cd Site_Codechella_Challenger-Alura
```

## Uso 💬

Para maior comodidade, você pode acessar diretamente pelo site 🌐[Acesse o site aqui](https://site-codechella-challenger-alura.vercel.app/). Também é possível fazer o download e abrir utilizando o Visual Studio Code, ou através do navegador.
